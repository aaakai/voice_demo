...
class EventType(StrEnum):
    ...
    DIALOGUE_DRAFT_UPDATED = "dialogue_draft_updated"
    RESPONSE_DRAFT_UPDATED = "response_draft_updated"
    RESPONSE_READY = "response_ready"
    FLOOR_DECISION_EMITTED = "floor_decision_emitted"
    TURN_GRANTED_TO_ASSISTANT = "turn_granted_to_assistant"
    TURN_REVOKED_FROM_ASSISTANT = "turn_revoked_from_assistant"
